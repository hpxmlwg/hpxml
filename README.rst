...
* `HPXML Toolbox <https://hpxml.nlr.gov>`_ - Validator and Data Dictionary (schema explorer).
* `HPXML Version Translator <https://github.com/NatLabRockies/hpxml_version_translator>`_ - This package converts an HPXML file to a newer version.
